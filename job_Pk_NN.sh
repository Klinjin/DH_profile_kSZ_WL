...
#SBATCH --output=Pk_nn_training.out
#SBATCH --error=Pk_nn_training.err
#SBATCH --mem=120G
...
RUN_NAME="mean_Pk_NN_1000_epochs_32_batch_smoother"

python /pscratch/sd/l/lindajin/DH_profile_kSZ_WL/src/models/pk_neural_emulator.py --max_epochs 1000 \
    --run_name ${RUN_NAME} \
    --batch_size 32 \
    --n_samples 100 \
    --mean_profile 